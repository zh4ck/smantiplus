                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <span class="app-brand-text demo text-body fw-bolder">Daftar SMANTI+</span>
                        </div>
                        <!-- /Logo -->
                        ...
                        <form id="formAuthentication" class="mb-3" action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    placeholder="Masukkan Nama" value="{{ old('name') }}" autofocus required />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="class" name="class"
                                    placeholder="Masukkan Kelas" value="{{ old('class') }}" autofocus required />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="phone" name="phone"
                                    placeholder="Masukkan Nomor Telepon" value="{{ old('phone') }}" autofocus
                                    required />
                            </div>
