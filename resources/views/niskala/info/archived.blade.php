...
@section('content')
        ...
        <div class="d-flex justify-content-center">
            <div class="div text-center">
                ...
                <div class="d-flex mt-5">
                    ...
                    <a href="/archived" class="btn btn-menu-active">Diarsipkan</a>
                </div>
            </div>
        </div>
    </div>
    @if ($archivedInfo->first() == '' && Auth::guard('student')->user()->role_id == 3)
        <h5 class="text-center mt-4 fw-medium">Belum ada informasi yang diarsipkan</h5>
    @elseif ($archivedInfo->first() == '' && Auth::guard('student')->user()->role_id == 4)
    ...
    @elseif ($archivedInfo->first() != '' && Auth::guard('student')->user()->role_id == 3)
        <div class="container-info mt-3">
            @foreach ($archivedInfo as $item)
