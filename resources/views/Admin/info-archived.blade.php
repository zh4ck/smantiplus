...
@section('title', 'Informasi Diarsipkan')
...
@section('content')
    ...
    <div class="card">
        <h5 class="card-header">List Informasi Diarsipkan</h5>
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    @foreach ($info as $item)
                        <tr>
                            <td>{{ $nomor++ }}</td>
                            <td>
                                <img src="{{ asset('storage/imgInfo/' . $item->imgInfo) }}" class="rounded-2" alt=""
                                    width="80px">
                            </td>
                            <td>{{ $item->title }}</td>
                            <td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <button type="button" class="dropdown-item" data-bs-toggle="modal"
                                            data-bs-target="#publishInfo{{ $item->slug }}"><i
                                                class="fa-solid fa-upload me-1"></i>
                                            Pulihkan
                                        </button>
                                        <button type="button" class="dropdown-item" data-bs-toggle="modal"
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="/deleteInfo/{{ $item->slug }}" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col mb-3">
                                                <input type="hidden" id="categories" name="categories" class="form-control"
                                                    readonly>
                                            </div>
                                        </div>
                        ...
                        <!-- Modal -->
                        <form action="/publish-byAdmin/{{ $item->slug }}" method="post">
                            @csrf
                            @method('put')
                            <div class="modal fade" id="publishInfo{{ $item->slug }}" tabindex="-1"
